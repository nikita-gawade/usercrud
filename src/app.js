...
const { queueConsumer } = require('./consumers/note.consumer');
...
if (process.env.ENVIRONMENT !== 'yap-local') {
  ...
  app.use(prometheusMiddleware({
    ...
    customLabels: ['ENVIRONMENT', 'MICROSERVICE_NAME'],
    transformLabels(labels) {
      // eslint-disable-next-line no-param-reassign
      labels.ENVIRONMENT = config.ENVIRONMENT;
      // eslint-disable-next-line no-param-reassign
      labels.MICROSERVICE_NAME = config.MICROSERVICE_NAME;
    },
  }));
}
